...
from lowkeyMusix.modules.play import generate_cover
from lowkeyMusix.modules.play import arq
from lowkeyMusix.modules.play import cb_admin_check
from lowkeyMusix.modules.play import transcode
from lowkeyMusix.modules.play import convert_seconds
from lowkeyMusix.modules.play import time_to_seconds
from lowkeyMusix.modules.play import changeImageSize
from lowkeyMusix.config import BOT_NAME as bn
from lowkeyMusix.config import DURATION_LIMIT
from lowkeyMusix.config import UPDATES_CHANNEL as updateschannel
from lowkeyMusix.config import que
from lowkeyMusix.function.admins import admins as a
from lowkeyMusix.helpers.errors import DurationLimitError
from lowkeyMusix.helpers.decorators import errors
from lowkeyMusix.helpers.admins import get_administrators
from lowkeyMusix.helpers.channelmusic import get_chat_id
from lowkeyMusix.helpers.decorators import authorized_users_only
from lowkeyMusix.helpers.filters import command
from lowkeyMusix.helpers.filters import other_filters
from lowkeyMusix.helpers.gets import get_file_name
from lowkeyMusix.services.callsmusic import callsmusic
from lowkeyMusix.services.callsmusic import client as USER
from lowkeyMusix.services.converter.converter import convert
from lowkeyMusix.services.downloaders import youtube
from lowkeyMusix.services.queues import queues
...
async def play(_, message: Message):
    global que
    lel = await message.reply("🔄 <b>sabar lagi di proses!💋 </b>")
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        "<b>JADIIN GW ADMIN DULU BODOH!</b>",
                    )
                    return
                ...
                try:
                    ...
                    # print(e)
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} kgk bisa join bot music asistennya ! makanya jangan di kick buaya coba cek @{ASSISTANT_NAME} di ban ga dari sini."
                        "\n\n atau tambahkan secara manual ya boty! bot music asistennya @{ASSISTANT_NAME}</b>",
                    )
    try:
    ...
    await lel.edit("🔎 <b>SABAR WOI GW LAGI NYARI LAGUNYA</b>")
    message.from_user.id
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/a8c7df44e848674930a2d.png"
        ...
        query = toxt
        await lel.edit("🎵 **bisa sabar ga sih boty!🖕🏻**")
        ...
        try:
            ...
            await lel.edit(
                "lu nyari lagu apaan sih kagak tau gw ! lu nyari apa bencong manly."
            )
            print(str(e))
            return
        try:    
...
async def jiosaavn(client: Client, message_: Message):
    global que
    lel = await message_.reply("🔄 **sabar lagi di proses!💋**")
    try:
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/a8c7df44e848674930a2d.png"
